...
//    /* Delete */
//
//    public static void deleteByPrimaryKey(Object dbObject) throws DBSerializerPrimaryKeyMissingException, DBSerializerException, IllegalAccessException, SQLException, InterruptedException {
...
//    }
//
//    public static void deleteByPrimaryKey(Class dbClass, Object primaryKey) throws DBSerializerPrimaryKeyMissingException, DBSerializerException, SQLException, InterruptedException {
...
//    }
//
//    public static void deleteWhere(Class dbClass, String col, SQLOperators operator, Object val) throws DBSerializerException, SQLException, InterruptedException {
//        deleteWhere(
//                dbClass,
//                Map.of(
//                        col, val
...
//    }
//
//    public static void deleteWhere(Class dbClass, Map<String, Object> colValMap, SQLOperators commonOperator) throws DBSerializerException, SQLException, InterruptedException {
...
//    }
//
//    public static void deleteWhere(Class dbClass, List<PSComponent> sqlConditions) throws DBSerializerException, SQLException, InterruptedException {
//        // Get tableName
//        String tableName = DBSerializer.getTableName(dbClass);
//
//        // Create componentized prepared statement
//        ComponentizedPreparedStatement cps = DeleteComponentizedPreparedStatementBuilder.forTable(tableName)
//                .where(sqlConditions)
//                .build();
//
//        delete(cps);
//    }
//
//    public static void delete(ComponentizedPreparedStatement cps) throws InterruptedException, SQLException {
...
//
//    public static List selectAllByPrimaryKey(Object dbObject) throws DBSerializerPrimaryKeyMissingException, DBSerializerException, IllegalAccessException, SQLException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException {
//        Object primaryKey = DBSerializer.getPrimaryKey(dbObject);
//
//        return selectAllByPrimaryKey(dbObject.getClass(), primaryKey);
//    }
//
//    public static List selectAllByPrimaryKey(Class dbClass, Object primaryKey) throws DBSerializerException, SQLException, InterruptedException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, DBSerializerPrimaryKeyMissingException {
//        String primaryKeyName = DBSerializer.getPrimaryKeyName(dbClass);
//
...
//    /* Update Where */
//
//    public static void updateWhereByPrimaryKey(Object dbObject, String toUpdateCol, Object newVal) throws DBSerializerPrimaryKeyMissingException, DBSerializerException, IllegalAccessException, SQLException, InterruptedException {
//        // Get primary key name and primary key
//        String primaryKeyName = DBSerializer.getPrimaryKeyName(dbObject.getClass());
//        Object primaryKey = DBSerializer.getPrimaryKey(dbObject);
//
//        // Update where with primary key name and primary key
//        updateWhere(
//                dbObject.getClass(),
//                toUpdateCol,
//                newVal,
