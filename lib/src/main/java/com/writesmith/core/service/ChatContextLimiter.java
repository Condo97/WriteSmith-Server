...
//    }
    ...
    public static List<Chat> getLimitedChats(List<Chat> chats, int characterLimit, boolean skipImages) {
        ...
        // Loop through Chats desc, if totalChars is less than characterLimit add Chat to limitedChats removing image if necessary and setting removedImage accordingly
