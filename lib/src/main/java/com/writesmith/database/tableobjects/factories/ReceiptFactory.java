...
public class ReceiptFactory {
    ...
    public static Receipt getMostRecentReceiptFromDB(Integer userID) throws DBSerializerException, SQLException, IllegalAccessException, DBObjectNotFoundFromQueryException {
