package com.writesmith.model.http.client.apple.itunes.response.error;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.writesmith.model.http.client.apple.itunes.response.AppleItunesBaseResponse;
