package com.writesmith.apple.iapvalidation.networking.itunes.response.verifyreceipt;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;

@JsonIgnoreProperties(ignoreUnknown = true)
public class VerifyReceiptLatestReceiptInfoResponse {
    ...
    public VerifyReceiptLatestReceiptInfoResponse() {

    }

    public VerifyReceiptLatestReceiptInfoResponse(String quantity, String product_id, String transaction_id, String original_transaction_id, String purchase_date, String purchase_date_ms, String purchase_date_pst, String original_purchase_date, String original_purchase_date_ms, String original_purchase_date_pst, String expires_date, String expires_date_ms, String expires_date_pst, String is_trial_period, String is_in_intro_offer_period, String in_app_ownership_type, String subscription_group_identifier, String web_order_line_item_id) {
        ...
        this.subscription_group_identifier = subscription_group_identifier;
    ...
    public String getSubscription_group_identifier() {
        return subscription_group_identifier;
    }

    public void setSubscription_group_identifier(String subscription_group_identifier) {
        this.subscription_group_identifier = subscription_group_identifier;
    }
