...
public class OpenAIGPTChatWrapperFiller extends OpenAIGPTChatFiller {
    ...
    public static void fillChatWrapperIfAble(ChatLegacyWrapper chatWrapper) throws SQLException, PreparedStatementMissingArgumentException, IOException, InterruptedException, OpenAIGPTException, CapReachedException, AppleItunesResponseException, DBSerializerException, IllegalAccessException, DBObjectNotFoundFromQueryException, InvocationTargetException, NoSuchMethodException, InstantiationException {
    ...
    public static void fillChatWrapperIfAble(ChatLegacyWrapper chatWrapper, Receipt receipt) throws SQLException, PreparedStatementMissingArgumentException, IOException, InterruptedException, OpenAIGPTException, CapReachedException, DBSerializerException {
        // Remember, count should be -1 if we want it to get from db!
        fillChatWrapperIfAble(chatWrapper, receipt, new MutableInteger(-1));
    }

    protected static void fillChatWrapperIfAble(ChatLegacyWrapper chatWrapper, Receipt receipt, IMutableInteger count) throws SQLException, PreparedStatementMissingArgumentException, IOException, InterruptedException, OpenAIGPTException, CapReachedException, DBSerializerException {
